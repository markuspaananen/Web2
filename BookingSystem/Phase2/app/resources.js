...
function updateCreateButtonState() {
  const canCreate = isNameValid && isDescriptionValid;
...
function attachResourceNameValidation(input) {
  const update = () => {
    ...
    isNameValid = isResourceNameValid(raw);
    setInputVisualState(input, isNameValid ? "valid" : "invalid");
    updateCreateButtonState();
  };
...
function attachResourceDescriptionValidation(input) {
  const update = () => {
    ...
    isDescriptionValid = isResourceDescriptionValid(raw);
    setInputVisualState(input, isDescriptionValid ? "valid" : "invalid");
    updateCreateButtonState();
  };
